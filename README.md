UserJS for improving inCaller's Redmine usability
=================================================

### Description ###

- Prevent changing textarea height on blur.
...
2. Install the user script by clicking here: [fix-incaller-redmine.user.js](https://github.com/inCaller/userjs-fix-incaller-redmine/raw/master/fix-incaller-redmine.user.js).
